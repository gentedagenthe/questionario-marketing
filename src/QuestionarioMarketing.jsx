      ...
      <div>
        ...
        <div className="container">
          <div className="card">
            ...
            <p>
              📍 Campo Grande/MS · 📄 CLT · 💰 R$ 2.200,00 fixo + até R$ 1.000,00 de premiação por metas
            </p>
            <p>
              🕗 Horário: segunda a sexta das 09h às 18h e sábado das 09h às 13h
            </p>
            <p>
        ...
        <div className="footer-genthe">@gentheconsultoria · (67) 99800-5656 · contato@genthe.com.br</div>
      </div>
    );
  }
